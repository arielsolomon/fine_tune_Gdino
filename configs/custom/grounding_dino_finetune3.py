...
# Defining metainfo explicitly to ensure it carries into the COCO API
metainfo = dict(
    classes=class_names,
...
val_evaluator = dict(
    ...
    metric='bbox',
    format_only=False,
    # backend_args=None helps bypass certain strict pycocotools checks
    backend_args=None,
    # Explicitly providing proposal_nums can sometimes stabilize one-class evaluation
