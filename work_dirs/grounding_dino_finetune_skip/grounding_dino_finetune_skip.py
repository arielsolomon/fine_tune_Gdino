...
default_hooks = dict(
    checkpoint=dict(interval=4, max_keep_ckpts=5, type='CheckpointHook'),
...
test_evaluator = dict(
    ann_file='/work/datasets/Chinase_env_arial_IR_fine_tune/labels/test.json',
    backend_args=None,
    format_only=False,
    metric='bbox',
    type='CocoMetric')
...
train_cfg = dict(max_epochs=50, type='EpochBasedTrainLoop', val_interval=51)
